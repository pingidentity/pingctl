...
func TestConfigGetCmd_Execute(t *testing.T) {
	err := testutils_command.ExecutePingctl(t, "config", "get")
...
func TestConfigGetCmd_FullKey(t *testing.T) {
	err := testutils_command.ExecutePingctl(t, "config", "get", profiles.WorkerClientIDOption.ViperKey)
	testutils_helpers.CheckExpectedError(t, err, nil)
}

// Test Config Get Command Executes when provided a partial key
func TestConfigGetCmd_PartialKey(t *testing.T) {
	err := testutils_command.ExecutePingctl(t, "config", "get", "pingone")
	testutils_helpers.CheckExpectedError(t, err, nil)
}
...
func TestConfigGetCmd_InvalidKey(t *testing.T) {
	...
	err := testutils_command.ExecutePingctl(t, "config", "get", "pingctl.invalid")
...
func TestConfigGetCmd_TooManyArgs(t *testing.T) {
	err := testutils_command.ExecutePingctl(t, "config", "get", profiles.ColorOption.ViperKey, profiles.OutputOption.ViperKey)
	testutils_helpers.CheckExpectedError(t, err, nil)
}
