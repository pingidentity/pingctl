...
func TestConfigSetCmd_Execute(t *testing.T) {
	err := testutils_command.ExecutePingctl("config", "set", fmt.Sprintf("%s=false", profiles.ColorOption.ViperKey))
...
func TestConfigSetCmd_InvalidValueType(t *testing.T) {
	...
	err := testutils_command.ExecutePingctl("config", "set", fmt.Sprintf("%s=invalid", profiles.ColorOption.ViperKey))
	testutils_helpers.CheckExpectedError(t, err, &expectedErrorPattern)
}
...
func TestConfigSetCmd_NoValueProvided(t *testing.T) {
	...
	err := testutils_command.ExecutePingctl("config", "set", fmt.Sprintf("%s=", profiles.ColorOption.ViperKey))
	testutils_helpers.CheckExpectedError(t, err, &expectedErrorPattern)
}
...
func TestConfigSetCmd_TooManyArgs(t *testing.T) {
	err := testutils_command.ExecutePingctl("config", "set", fmt.Sprintf("%s=false", profiles.ColorOption.ViperKey), fmt.Sprintf("%s=json", profiles.OutputOption.ViperKey))
	testutils_helpers.CheckExpectedError(t, err, nil)
}
