...
func TestConfigUnsetCmd_Execute(t *testing.T) {
	err := testutils_command.ExecutePingctl(t, "config", "unset", profiles.ColorOption.ViperKey)
...
func TestConfigUnsetCmd_NoArgs(t *testing.T) {
	...
	err := testutils_command.ExecutePingctl(t, "config", "unset")
...
func TestConfigUnsetCmd_InvalidKey(t *testing.T) {
	...
	err := testutils_command.ExecutePingctl(t, "config", "unset", "pingctl.invalid")
	testutils_helpers.CheckExpectedError(t, err, &expectedErrorPattern)
}
...
func TestConfigUnsetCmd_TooManyArgs(t *testing.T) {
	err := testutils_command.ExecutePingctl(t, "config", "unset", profiles.ColorOption.ViperKey, profiles.OutputOption.ViperKey)
	testutils_helpers.CheckExpectedError(t, err, nil)
}
...
func TestConfigUnsetCmd_CheckViperConfig(t *testing.T) {
	...
	err := testutils_command.ExecutePingctl(t, "config", "unset", viperKey)
	testutils_helpers.CheckExpectedError(t, err, nil)
