...
func TestPlatformCmd_Execute(t *testing.T) {
	err := testutils_command.ExecutePingctl(t, "platform")
...
func TestPlatformCmd_InvalidFlag(t *testing.T) {
	...
	err := testutils_command.ExecutePingctl(t, "platform", "--invalid")
...
func TestPlatformCmd_HelpFlag(t *testing.T) {
	err := testutils_command.ExecutePingctl(t, "platform", "--help")
	testutils_helpers.CheckExpectedError(t, err, nil)

	err = testutils_command.ExecutePingctl(t, "platform", "-h")
	testutils_helpers.CheckExpectedError(t, err, nil)
}
