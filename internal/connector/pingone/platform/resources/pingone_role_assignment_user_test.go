...
func TestRoleAssignmentUserExport(t *testing.T) {
	...
	resource := resources.RoleAssignmentUser(sdkClientInfo)
	...
	expectedImportBlocks := []connector.ImportBlock{
		{
			...
			ResourceID:   fmt.Sprintf("%s/8012b4a3-1874-42d3-803d-76d4a378335c/37cb92f1-858f-4cce-afa9-4d1bbd2a6b4e", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_role_assignment_user",
			ResourceName: "test_user_Identity Data Admin_POPULATION_2",
			ResourceID:   fmt.Sprintf("%s/8012b4a3-1874-42d3-803d-76d4a378335c/ed3ecdd9-973c-4cab-b6d1-e5474e25309e", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_role_assignment_user",
			ResourceName: "test_user_Identity Data Admin_POPULATION_3",
			ResourceID:   fmt.Sprintf("%s/8012b4a3-1874-42d3-803d-76d4a378335c/2c2a1bb4-9d07-4c29-86ab-143b2cbb3bb6", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_role_assignment_user",
			ResourceName: "test_user2_Identity Data Read Only_ENVIRONMENT_1",
			ResourceID:   fmt.Sprintf("%s/7570f416-5503-4eb0-9fc3-9a485bddd411/71219163-1a98-45ed-827c-d4ad6e3ff1d4", testutils.GetEnvironmentID()),
		},
		{
			ResourceType: "pingone_role_assignment_user",
